    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 _node_136_var = UnpackNormal(tex2D(_node_136,TRANSFORM_TEX(i.uv0, _node_136)));
                float3 normalLocal = _node_136_var.rgb;
